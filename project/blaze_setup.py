...
# There should appear a url to blazegraph in the terminal, change it if it is different from the one in SPARQLWrapper, but include the /blazegraph/namespace/ at the end. 
